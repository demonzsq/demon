...
var fag=false;
  function register(){
	  ...
	  $.ajax({
		  type : "post",
		  url : "lonReAction.action",
		  data : {methodName:'judegIfUserName',user_name:uname},
		  success : function(data){
			  fag=data;
			  if(fag=="false"){
					  document.getElementById("span1").innerHTML="亲，该用户名已存在";
			 	 }else{
					  fag=true;
...
<!--end nav-->
	...
	<div class="logoin_wrap mt30">
		<h2>用户注册</h2>
		<div id="table">
		<form id="form1"  action="lonReAction.action?methodName=userRegister" onsubmit="return register2()"  method="post">  
			<table width="100%" border="0" cellspaci action="##" ng="0" cellpadding="0">
			...
			<table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td width="56%" align="left" valign="middle">
						...
						<input type="image" value="注册"  src="../images/admin_zc.png"/>
					</td>
				</tr>
			</table>
